          ...
          Container(
            ...
            child: Container(
              ...
              child: GridView.count(
                ...
                mainAxisSpacing: 30,
                children: [
                  itemDashboard('Orders', CupertinoIcons.play_rectangle,
                      Colors.deepOrange),
                  itemDashboard('Consaltancy Booking',
                      CupertinoIcons.graph_circle, Colors.green),
                  itemDashboard(
                      'plants', CupertinoIcons.person_2, Colors.purple),
                  itemDashboard(
                      'Equpments', CupertinoIcons.chat_bubble_2, Colors.brown),
